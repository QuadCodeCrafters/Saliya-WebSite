        ...
        <div class="row align-items-center callback-container">
            ...
            <div class="col-md-6">
                <div class="callback-form">
                    ...
                    <form action="carrierServicePagethree.php" method="post">
                        <div class="row mb-3">
                            <div class="col">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <input type="tel" pattern="\+94[0-9]{9}" name="phone" class="form-control" placeholder="Phone Number" required>
                            </div>
                             <label style="">Use this format for the phone no : +94 (Your phone number)</label>
                            <div class="col">
                                <input style="margin-top:10px;" type="email" name="mail" class="form-control" placeholder="Email" required>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                        <input type="text" class="form-control" name="NIC" placeholder="NIC (National Identity Card Number)" required>
                        </div>
                        <div class="mb-3">
                        <?php $today = date("Y-m-d");?>
                        <input type="text" class="form-control" name="date" disabled placeholder="Date" value="<?php echo "{$today}";?>">
                        </div>
                        <div class="mb-3">
                          <!--check box ui--> 
                          <div class="checkbox-wrapper-46">
                            <input type="checkbox" name="agreement" id="cbx-46" class="inp-cbx"/>
                                ...
                                <span>
                                  I agree for, the collecting of my personal details<br> for a better service
                                </span>
                              </label>
                            </div>
                          </div>
                          <?php if($availableNum == 0){?>
                        <button disabled type="submit" class="btn btn-learn-more px-4 py-2" style="background-color:#00258a;">Next</button>
                    <?php }else{?>
                        <button type="submit" class="btn btn-learn-more px-4 py-2" style="background-color:#00258a;">Next</button>
                        <?php }?>
                    </form>
                </div>
            </div>
